...
struct PreviewOwnerService: OwnerService {
    func snapshot(stationId: String?) async throws -> OwnerSnapshot {
        ...
        return OwnerSnapshot(asOf: .now, stationName: selected.name, salesToday: first ? 387_633 : 214_820, transactions: first ? 148 : 91, collectedToday: first ? 379_400 : 210_300, netProfitToday: first ? 28_740 : 17_640, meteredVolume: first ? 4_010 : 2_230, openShifts: selected.openShifts, pendingReconciliations: first ? 1 : 0, stations: stations, tanks: first ? [OwnerTank(id: "ms-1", code: "T-1", productCode: "MS", bookStock: 6_240, workingCapacity: 19_000, fillPercent: 32.8, status: "HEALTHY", sellingPrice: 102, density: 742.5), OwnerTank(id: "hsd-1", code: "T-2", productCode: "HSD", bookStock: 11_850, workingCapacity: 19_000, fillPercent: 62.4, status: "HEALTHY", sellingPrice: 94, density: 834.2)] : [OwnerTank(id: "ms-2", code: "T-1", productCode: "MS", bookStock: 2_900, workingCapacity: 15_000, fillPercent: 19.3, status: "LOW", sellingPrice: 103, density: nil), OwnerTank(id: "hsd-2", code: "T-2", productCode: "HSD", bookStock: 8_100, workingCapacity: 20_000, fillPercent: 40.5, status: "HEALTHY", sellingPrice: 95, density: 835)], collections: [OwnerCollection(method: "CASH", amount: first ? 174_400 : 98_300), OwnerCollection(method: "UPI", amount: first ? 145_000 : 82_000), OwnerCollection(method: "CARD", amount: first ? 60_000 : 30_000)], alerts: alerts)
    }
}
