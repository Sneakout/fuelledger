...
export type CatalogProduct = { id: string; name: string; code: string; category: string; unit: string; purchasePrice: string; sellingPrice: string; inventoryTracked: boolean; tankLinked: boolean; meterLinked: boolean; isService: boolean; active: boolean; taxCategoryId: string | null; customCategoryId: string | null; taxCategory: CatalogTaxCategory | null; customCategory: CatalogCategory | null };
...
export type PurchaseProduct={id:string;name:string;code:string;unit:string;purchasePrice:string;tankLinked:boolean};
