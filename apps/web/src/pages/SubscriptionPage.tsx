...
export function SubscriptionPage() {
  ...
  return <main className="page subscription-page">
    ...
    <section className="sp-founding"><Sparkles /><div><small>FOUNDING FUEL STATION OFFER</small><h3>{money(11999)} for your first year of Core + Fuel Intelligence</h3><p>For the first 50 fuel stations, subject to availability. Renews at {money(14999)}/year. GST additional.</p></div><a href="tel:+918977506454">Check availability <ArrowRight size={17} /></a></section>
